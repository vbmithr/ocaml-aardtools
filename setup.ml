...
(* OASIS_START *)
(* DO NOT EDIT (digest: 25754fe3417b815fdcbe9b44107d8c7f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Aarddict tools for OCaml";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Aard"; "Aard_j"; "Aard_t"; "Util"];
                      lib_pack = false;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "xdxf_of_wb.ml"; });
               Executable
                 ({
                     cs_name = "json_of_wb";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "json_of_wb.ml"; });
               Executable
                 ({
                     cs_name = "aard_of_json";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "aard_of_json.ml"; });
               Executable
                 ({
                     cs_name = "compile_aard";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "compile_aard.ml"; });
               Executable
                 ({
                     cs_name = "aard_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "aard_test.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\190\174\157\rl`\141G\174R\236]Q\177\145\170";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
